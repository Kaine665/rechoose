...
const zh = {
  ...
  "help.exit": "收起",
  "help.pick.title": "这一次,你想怎么 Rechoose?",
  "help.pick.sub": "选一个方案立即执行,也可以不使用方案,只记录发生了什么。",
  "help.pick.saved": "你准备好的方案",
...
const en = {
  ...
  "help.exit": "Close",
  "help.pick.title": "How do you want to Rechoose this time?",
  "help.pick.sub": "Use a prepared response now, or skip the plan and simply record what happened.",
  "help.pick.saved": "Your prepared responses",
