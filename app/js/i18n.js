...
const zh = {
  ...
  "onboard.1.title": "当冲动来临时,<br>帮你重新获得一次选择。",
  "onboard.1.body": "这里不计算你\"坚持了多少天\",<br>也不会评判你。<br>它只做一件事:在最难的那几分钟,陪你走过去。",
  "onboard.2.title": "它是这样工作的",
  "onboard.2.s1.title": "平静时,准备好计划",
  "onboard.2.s1.body": "写下你的触发情境,和你想做的替代行动。",
  "onboard.2.s2.title": "冲动来时,打开它",
  "onboard.2.s2.body": "它会带你呼吸,然后一步步执行你自己的计划。",
  "onboard.2.s3.title": "结束后,看到变化",
  "onboard.2.s3.body": "不管结果如何,每一次记录都让你更了解自己。",
  ...
  "help.arrive.sub": "打开这个页面,本身就是一次选择。<br>冲动像海浪,它会升起,也一定会退去。",
  ...
  "help.outcome.changed": "🌿 我做出了不同的选择",
  "help.outcome.changedSub": "冲动出现了,但这次我改变了行为",
  "help.outcome.followed": "🌧️ 这次顺着冲动走了",
  ...
  "help.close.changed": "你刚刚证明了:冲动不等于必须行动。",
  ...
  "progress.urges": "过去 30 天,冲动出现",
  "progress.changed": "其中,你改变了行为",
...
const en = {
  "app.name": "Rechoose",
  "app.desc": "When an urge arises, help yourself reclaim a moment of choice.",
  ...
  "onboard.1.title": "When an urge arises,<br>help yourself reclaim a choice.",
  "onboard.1.body": "This isn't about streak days,<br>and it won't judge you.<br>It does one thing: walk with you through the hardest few minutes.",
  "onboard.2.title": "How it works",
  "onboard.2.s1.title": "When calm, prepare a plan",
  "onboard.2.s1.body": "Write your triggers and the actions you'll take instead.",
  "onboard.2.s2.title": "When the urge hits, open this",
  "onboard.2.s2.body": "Breathe first, then follow your own plan step by step.",
  "onboard.2.s3.title": "Afterwards, see the change",
  "onboard.2.s3.body": "Whatever the outcome, each record helps you know yourself better.",
  ...
  "help.arrive.sub": "Opening this page is already a choice.<br>Urges rise like waves — and they always fall.",
  ...
  "help.outcome.changed": "🌿 I made a different choice",
  "help.outcome.changedSub": "The urge showed up, but I changed what I did",
  "help.outcome.followed": "🌧️ I followed the urge this time",
  ...
  "help.close.changed": "You just proved: an urge is not an order.",
  ...
  "planEdit.sub": "When the trigger appears, which actions will you take instead?",
  "planEdit.icon": "Icon",
  "planEdit.name": "Name",
  "planEdit.namePh": "e.g. Night alone",
  "planEdit.trigger": "Trigger situation",
  "planEdit.triggerPh": "e.g. Alone + phone",
  "planEdit.triggerHint": "When does the urge show up most easily?",
  ...
  "progress.urges": "Urges in the last 30 days",
  "progress.changed": "Times you changed the behavior",
  ...
  "progress.legend.followed": "Followed the urge",
  ...
  "progress.tag.followed": "Followed the urge",
